package com.vsantander.speedrun.ui.base.activity
...
import com.vsantander.speedrun.di.Injectable
        ...
        intent?.let { intent ->
            intent.extras?.let {
                if (intent.extras.containsKey(EXTRA_ANIMATION_TYPE)) {
                    animationTypeEnter = intent.extras.getInt(EXTRA_ANIMATION_TYPE)
                    animationTypeExit = intent.extras.getInt(EXTRA_ANIMATION_TYPE)

                } else if (intent.extras.containsKey(EXTRA_ANIMATION_ENTER) &&
                        intent.extras.containsKey(EXTRA_ANIMATION_EXIT)) {

                    animationTypeEnter = intent.extras.getInt(EXTRA_ANIMATION_ENTER)
                    animationTypeExit = intent.extras.getInt(EXTRA_ANIMATION_EXIT)
                }
            }
        }
